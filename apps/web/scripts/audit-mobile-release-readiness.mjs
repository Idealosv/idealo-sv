...
ok('runtime diferido móvil está conectado',main.includes("lazy(()=>import('./DeferredRuntimeHosts.jsx'))"))
ok('facturación móvil está montada',has(deferred,'<MobileDteHost/>','<MobileCollectionsHost/>'))
...
ok('bridge de notificaciones está montado',deferred.includes('<MobileNotificationBridge/>'))
