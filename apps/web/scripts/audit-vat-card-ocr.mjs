...
assert.match(combinedImage, /tightenRectToCard/)
assert.match(combinedImage, /activeRange/)
assert.match(combinedImage, /gray < 232/)
assert.match(combinedImage, /Math\.max\(1800/)
assert.match(combinedImage, /imageSmoothingQuality = 'high'/)
assert.match(combinedImage, /frontCropRatio/)
assert.match(combinedImage, /backCropRatio/)
...
console.log('✓ OCR IVA: recorte ajustado, nombre del contribuyente, ambas caras, tres giros y validación de ruido verificados')