...
const tabs=['Ejecutivo','Resultados','Liquidez','Rentabilidad','Conciliación']
export default function FinancialDashboardLauncher(){
 const [session,setSession]=useState(null),[company,setCompany]=useState(null),[open,setOpen]=useState(false),[tab,setTab]=useState('Ejecutivo')
