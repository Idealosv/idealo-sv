      ...
      <section className="erp-modal-panel billing-modal" role="dialog" aria-modal="true" aria-label="Módulo de facturación" onMouseDown={(event) => event.stopPropagation()}>
        ...
        <div className="billing-workspace">
          ...
          <main className="billing-content">
            ...
            {activeSection === 'documentos' && <section className="billing-section-card"><div className="billing-section-intro"><div><strong>Facturas y estados</strong><small>Historial de DTE-01 y DTE-03 desde borrador hasta respuesta de Hacienda.</small></div></div><ProcessedDtePanel supabase={supabase} company={company} session={session} onOpenHacienda={() => selectSection('hacienda')}/></section>}
