...
export default function IdealoBarSimpleManagement({company,supabase,access,onOpenCatalog,onOpenInventory}){
 ...
 return <section className="bar-simple-management-home">
  ...
  <div className="bar-simple-help"><b>Forma recomendada de trabajar:</b><span>Vender → revisar Caja/Control → consultar Inventario → cerrar el día desde Gestión. Usa Salud del sistema para confirmar que no exista ninguna inconsistencia crítica.</span></div>
 </section>
}
