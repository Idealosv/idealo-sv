-- IDEALO SV · Reportes y Finanzas consolidados
create or replace function public.financial_report_summary(p_company uuid,p_from date,p_to date)
returns table(
 sales numeric, purchases numeric, cash_income numeric, cash_expense numeric, cash_net numeric,
 receivable_balance numeric, payable_balance numeric, available_cash numeric,
 reconciliations_with_difference bigint, closed_days bigint
)
...
begin
 ...
 select s.v,p.v,cm.i,cm.e,(cm.i-cm.e)::numeric,ar.v,ap.v,cb.v,rc.v,dc.v from s,p,cm,ar,ap,cb,rc,dc;
end;$$;
